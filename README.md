...
Windows port of [Clicky](https://github.com/farzaa/clicky) by [@farzaa](https://github.com/farzaa), originally built for macOS. All credit for the idea, design, and architecture goes to him I just re-implemented it in C# so it runs natively on Windows. Most Documentation is just control F, and replace
